...
parser = argparse.ArgumentParser(description="Fetch UniProt annotations for cluster members.")
parser.add_argument('--input', required=True, help='Input: File containing cluster information (.txt file)')
parser.add_argument('--output', required=True, help='Output: .txt file containing complete annotation for each member of the clusters')
